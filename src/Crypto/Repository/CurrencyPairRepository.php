...
namespace App\Crypto\Repository;
...
class CurrencyPairRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CurrencyPair $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CurrencyPair $entity, bool $flush = true): void
    {
